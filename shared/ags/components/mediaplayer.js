...
// mpris.connect('changed', (service, ...args) => {
//     print(service, ...args)
// })
...
function formatTime(timeInSeconds) {
    ...
    // Calculate if leading zero is needed or not
...
function Player(player) {
    ...
    const lengthLabel = Widget.Label({
        ...
        label: player.bind("length").transform(formatTime),
    })
...
export function Media() {
    return Widget.Box({
        class_name: "media",
        vertical: true,
        css: "min-height: 2px; min-width: 450px;", // small hack to make it visible
